  ...
  return (
    <div className={styles.container}>
      <div className={styles.titleContainer}>
        <h2 className={styles.title}>Mon Histoire</h2>
        <ScintillantLogo />
      </div>
      ...
      <div className={styles.listImages}>
        <Image src={marteauImage} alt="our story 1" width={350} height={250} />
        <Image src={balanceImage} alt="our story 2" width={350} height={250} />
        <Image src={libraryImage} alt="our story 3" width={350} height={250} />
      </div>
    </div>
  );
};
