export const services = {
    ...
    services: [
      {
        title: "Vefa",
        description:
          "La vente en l'état futur d'achèvement (VEFA) est un contrat de construction d'immeuble à usage d'habitation ou à usage professionnel comportant au moins un lot. Il est régi par les articles L. 261-1 et suivants du Code de la construction et de l'habitation.",
      },
      {
        title: "Vente",
        description:
          "Lors de la vente d’un bien immobilier (maison, appartement, terrain, cave, parking, …), vendeur et acquéreur doivent respecter toutes sortes d’obligations. Notre office va pouvoir vous accompagner afin de respecter ces obligations, et de réaliser votre projet en toute sécurité.",
      },
      {
        title: "Echange",
        description:
  ...
  Famille: {
    ...
    services: [
      ...
      {
        title: "CHANGEMENT RÉGIME MATRIMONIAL",
        description:
